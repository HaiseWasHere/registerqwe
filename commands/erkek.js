...
let mesaj = new Discord.MessageEmbed() .setColor('BLUE') .setDescription("Kullanıcı Başarıyla Kayıt Edildi, <@&${set.roller.erkek}> ve <@&${set.roller.erkek2}> Rolleri Verildi") .setFooter('haise burdaydi!');
client.channels.cacge.get(set.kanallar.kayıtkanal).send(mesaj)


let mesaj = new Discord.MessageEmbed().setColor('BLUE').setDescription("Kayıt Başarılı \n Kayıt Eden Yetkili : ${message.author} \n Verilen Rol : <@&${set.roller.erkek}> <@&${set.roller.erkek2}> \n Alınan Rol : <@&${set.roller.unregister}>") .setFooter('haise burdaydi!');
